...
>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="title" class="form-control" type="text" value="{{ $aboutpage ? $aboutpage->title : '' }}"
  id="example-text-input">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="short_title" class="form-control" type="text" value="{{ $aboutpage ? $aboutpage->short_title : '' }}"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
